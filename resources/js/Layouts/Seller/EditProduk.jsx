// resources/js/Pages/Seller/EditProduk.jsx
...
export default function EditProduk({ produk, kategoris, tipeProduks }) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        tipe_produk_id: produk.tipe_produk_id,
        new_tipe_produk: '',
    ...
    // Load preview foto saat pertama kali render
    useEffect(() => {
        if (produk.foto) {
            setPreviews([{ preview: `/storage/${produk.foto}` }]);
        }
    }, [produk.foto]);
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {showNewTipe && (
                    <div>
                        ...
                        <TextInput
                            ...
                            color={errors.new_tipe_produk ? 'failure' : 'gray'}
                        />
                    </div>
                )}
                ...
                <div>
                    ...
                    <FileInput
                        ...
                        helperText="Tambahkan gambar baru ke gallery"
                        icon={
                            <Icon
                                icon="solar:camera-minimalistic-outline"
                                className="h-5 w-5"
